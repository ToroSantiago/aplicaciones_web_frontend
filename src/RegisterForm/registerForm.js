      ...
      <div className="auth-card">
        ...
        <div className="auth-content">
            ...
            <div className="form-group">
              ...
              <div className="password-container">
                <input
                  ...
                  disabled={loading}
                />
                <button type="button" className="password-toggle" onClick={togglePassword} disabled={loading}>
                  <span>{showPassword ? "🙈" : "👁️"}</span>
                </button>
              </div>
              {errors.password && <span className="error-message">{errors.password}</span>}
              <small className="form-hint">Debe contener mayúsculas, minúsculas, números y símbolos</small>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="password-container">
                <input
                  ...
                  disabled={loading}
                />
                <button type="button" className="password-toggle" onClick={togglePasswordConfirm} disabled={loading}>
          ...
          <div className="auth-switch">
            ...
            <button type="button" className="link-btn" onClick={handleLogin} disabled={loading}>
              Inicia sesión aquí
            </button>
          </div>
        </div>
